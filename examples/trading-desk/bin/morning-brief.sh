...
OPENINTEL="mcp__openintel__market_clock,mcp__openintel__brief,mcp__openintel__recent_events,mcp__openintel__analyze_ticker,mcp__openintel__scan_watchlist,mcp__openintel__compare_tickers,mcp__openintel__list_sources,mcp__openintel__risk_frame,mcp__openintel__open_positions,mcp__openintel__review_trades"
